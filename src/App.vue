		...
		<div class="md:flex">
			...
			<div class="md:hidden relative">
				...
				<div class="absolute top-1 flex justify-center w-full">
					<img class="max-w-72" src="/img/image-mockups.png" alt="" />
				</div>
			</div>

			<div
				class="lg:my-40 lg:mx-28 mx-5 my-12 flex justify-center items-center"
			>
				<div>
					<h1
						class="lg:text-6xl md:max-w-sm text-4xl text-center md:text-left xl:max-w-lg text-gray-700 my-3 font-light"
					>
						Next generation digital banking
					</h1>
					<p
						class="lg:max-w-lg md:max-w-sm lg:text-xl text-center md:text-left text-tc lg:my-10 my-5"
					>
						Take your finance life online. Your Easybank account will be a
						one-stope-shope for spending, saving, budgeting, investing, and much
						more.
					</p>
					<div class="flex justify-center md:block">
						<button
							class="bg-gradient-to-r from-limeG to-cyan text-white py-3 px-9 rounded-full"
						>
							Request Invite
						</button>
					</div>
			...
			<div class="hidden lg:block">2</div>
		</div>
	</main>
</template>
