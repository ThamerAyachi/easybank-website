<template>
	...
	>
		...
		<!-- links -->
		<ul class="hidden lg:flex space-x-8 text-tc">
			<li>
				<a href="#">Home</a>
			</li>
			<li>
		...
		<div class="lg:hidden">
			<button class="text-black p-2" @click="dropdownOpen = !dropdownOpen">
			...
			>
				...
				>
					...
					<a href="#" class="w-full block text-center p-3">Contact</a>
					<a href="#" class="w-full block text-center p-3">Blog</a>
					<a href="#" class="w-full block text-center p-3">Careers</a>
				</div>
			</transition>
		</div>
	</nav>
